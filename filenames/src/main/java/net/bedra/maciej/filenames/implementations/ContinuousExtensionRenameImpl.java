 ...
 * @author Maciej Bedra
 */
public class ContinuousExtensionRenameImpl implements RenameInterface {
	...
	/**
	 * ContinuousExtensionRenameImpl constructor.
	 *
	 ...
	 */
	public ContinuousExtensionRenameImpl(String directory, String coreNameValue, String startNumberValue, String extension, TextArea userLogArea) {
		...
		if (FileUtils.isDirectory(directory)) {
			...
			if (coreName != null) {
				...
				if (startNumber != null) {
					...
					log.info(
						"Starting rename operation in mode [continuousMode,extFiles] for extension and directory [startNumber = {}, patternLength = {}, coreName = {}, extension = {}, path = {}]...",
						startNumber,
						patternLength,
						coreName,
						extension,
